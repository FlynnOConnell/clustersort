...
def Processing(chan_num, h5_filepath, params):  # Define function
    retried = 0
    while True:
        try:
            ...
            # Existence of the directories indicates a job restart on the cluster, so restart afresh.
            ...
            slices = np.array(getattr(hf5.root.SPKwf, 'SPK' + f'{chan_num + 1:02d}')[:])  # get spike slices
